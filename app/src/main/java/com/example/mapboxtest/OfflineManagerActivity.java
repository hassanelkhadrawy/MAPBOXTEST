...
public class OfflineManagerActivity extends AppCompatActivity {
        ...
        map.getStyle(new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                try {
                    ...
                    Log.d("Failed to encode metadata: %s", exception.getMessage());
                    metadata = null;
                }
                ...
                offlineManager.createOfflineRegion(definition, metadata, new OfflineManager.CreateOfflineRegionCallback() {
                    ...
                    public void onCreate(OfflineRegion offlineRegion) {
                       Log.d( "Offline region created: %s" , regionName);
                    ...
                    public void onError(String error) {
                        Log.d(TAG, "onError:while download "+error);
        ...
        offlineRegion.setObserver(new OfflineRegion.OfflineRegionObserver() {
            ...
            public void onStatusChanged(OfflineRegionStatus status) {
                ...
                // Log what is being currently downloaded
                  Log.d("%s/%s resources; %s bytes downloaded.",
            ...
            public void onError(OfflineRegionError error) {
                Log.d("onError reason: %s", error.getReason());
                Log.d("onError message: %s", error.getMessage());
            }

            @Override
            public void mapboxTileCountLimitExceeded(long limit) {
                Log.d("Mapbox tile count limit exceeded: %s", ""+limit);
            }
        });
    ...
    private String getRegionName(OfflineRegion offlineRegion) {
        ...
        try {
            ...
            Log.d("Failed to decode metadata: %s", exception.getMessage());
